...
export const projects = [
  { 
    ...
    slug: "weddingavenue",
    description: `Large-capacity wedding venue featuring a 1500-guest hall, 500-person indoor dining space, and 1500+ guest open lawn.

Hospitality-focused amenities including guest cottages, a premium private bridal cottage, landscaped zones, and a swimming pool.

Nature-integrated design that follows the site’s natural slope and blends seamlessly with the mountain-rich surroundings of Satara.`,
    media: [
...
Includes a dedicated doctor’s relaxation room with cozy seating and calming materials, reflecting the clinic’s focus on wellness and functionality.
`,
    media: [
  ...
  { 
    ...
    slug: "arch-bungalow",
    description: `Elegant Minimalist Façade: Clean linear geometry enhanced with natural beige tones, vertical wooden accents, and subtle detailing creates a warm, welcoming, and timeless exterior.

Light-filled, Connected Interiors: Expansive windows and integrated balcony planters invite abundant natural light and foster a seamless connection between indoor and outdoor living spaces.

Thoughtful Functional Design: Secure ground-level base, patterned gates, and carefully layered greenery balance practicality with aesthetic appeal, giving the home a modern yet vibrant presence.`,
    media: [
      { type: 'image', src: "https://ik.imagekit.io/2ssa5wpda/paperspace/archb/AB1.webp?updatedAt=1764268201945", alt: 'Front Elevation' }
    ]
  },
  { 
    id: 6, 
    ...
    description: `Classical-inspired architecture with ornate columns, tall French windows, detailed cornices, and refined facade composition.

Luxurious spatial character enhanced by large illuminated openings, symmetrical design, and premium exterior finishes.

Harmonious natural setting with lush greenery, landscaped edges, and a serene backdrop typical of Igatpuri’s hillside environment.`,
    media: [
  ...
  { 
    ...
    category: "Urban - Interior Design", 
    year: "2025",
    location:"Pune, Maharashtra",
    slug: "int-ek-gaon-ek-shivjayanti",
    description: `Cultural Elegance – The design blends traditional Maharashtrian elements like ornate arches, carved black columns, and a regal backdrop featuring the iconic figure of Chhatrapati Shivaji Maharaj.

Warm & Functional Ambience – Soft lighting, warm wooden tones, and earthy textures create an inviting space suited for dignified gatherings and conversations.

Thoughtful Spatial Planning – The L-shaped seating layout, minimal décor accents, and a central low table ensure comfort, clarity, and purposeful interaction within an urban interior setting.`,
    media: [
      { type: 'image', src: "https://ik.imagekit.io/2ssa5wpda/paperspace/shivjayanti/Jayanti2.webp?updatedAt=1764268202033", alt: 'Cultural Hall Overview' },
